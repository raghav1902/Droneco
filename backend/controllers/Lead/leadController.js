...
const FeedbackLog = require('../../models/Lead/FeedbackLog');
...
const getLeads = async (req, res) => {
  try {
    ...
    // Execute query and sort by submitted_at descending
    const leads = await Lead.find(query).sort({ submitted_at: -1 });
